...
Die LED zeigt einen niedrigen Akkustand in, indem sie beginnt durchgehend zu leuchten. Die Funtion dafür befindet sich in Zeile 250.   Wenn die output Spannung des Akkus zu niedrig wird, als dass die Motoren mit ausreichend Energie versorgt werden können, beginnt die LED permanent zu leuchten. Diese Warnung bedeutet nicht, dass der Quadrocopter nicht mehr fliegen kann, aber er sollte in absehbarer Zeit gelandet werden.  

Darüber befindet sich eine Funktion, die es für den Arduino einfacher macht, den Akkustand zu errechnen, durch einen komplementären noise filter. Mit diesem treten weniger Ungenauigkeiten beim errechnen der Spannung des Akkus und die LED zeigt nicht schon zu früh einen niedrigen Akkustand an.  
